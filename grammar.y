...
construct_while : 
    ...
    T_RPAR 
    {
      ...
      // evaluates to zero.
      itab_instruction_add (itab, OP_JZ, $4->addr, UNUSED_ARG, INSTRUCTION_NEXT + 2);
...
construct_if :
    ...
    T_RPAR 
    {
      ...
      itab_instruction_add (itab, OP_JZ, $3->addr, NOARG, UNUSED_ARG);
...
assignment : T_ID arr_index T_ASSIGN a_expr 
    {
      ...
      if ( $2 != NULL) 
      {
        ...
        itab_instruction_add (itab, opcode, sym->addr, src_temp->addr, $2->addr);
      }
      else
      {
